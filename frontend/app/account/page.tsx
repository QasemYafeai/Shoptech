...
export default function AccountPage() {
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Errors are handled in updateProfile via showToast
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handlePasswordUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Errors are handled in updatePassword via showToast
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
        ...
        <div className="flex items-center justify-center h-[70vh]">
          <div className="text-center">
            <div className="w-16 h-16 border-t-4 border-green-500 rounded-full animate-spin mx-auto mb-6"></div>
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
              ...
              <nav className="p-2">
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-lg flex items-center transition ${activeTab === 'profile' ? 'bg-green-900/30 text-green-500' : 'hover:bg-gray-700'}`}
                >
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-lg flex items-center transition ${activeTab === 'orders' ? 'bg-green-900/30 text-green-500' : 'hover:bg-gray-700'}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-lg flex items-center transition ${activeTab === 'security' ? 'bg-green-900/30 text-green-500' : 'hover:bg-gray-700'}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                  </svg>
                  Security
                </button>
              ...
              <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                ...
                {ordersLoading ? (
                  <div className="text-center py-10">
                    <div className="w-12 h-12 border-t-4 border-green-500 rounded-full animate-spin mx-auto mb-4"></div>
                  ...
                  <div className="text-center py-10 bg-gray-900/30 rounded-lg border border-gray-700 border-dashed">
                    ...
                    <Link href="/" className="px-6 py-2 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition inline-block">
                      Start Shopping
                    </Link>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <div key={order._id} className="bg-gray-900/50 rounded-lg border border-gray-700 overflow-hidden">
                        ...
                        <div className="p-4 bg-gray-800 flex justify-between items-center">
                          ...
                          <Link href={`/order/${order._id}`} className="px-4 py-1 bg-gray-700 text-white rounded hover:bg-gray-600 transition text-sm">
                            View Details
                          </Link>
                        </div>
                      </div>
              ...
              <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                ...
                <div className="border-t border-gray-700 mt-8 pt-6">
                  ...
                  <div className="bg-gray-900/50 p-4 rounded-lg">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2h2" />
                        </svg>
                ...
                <div className="border-t border-gray-700 mt-8 pt-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    <button className="px-4 py-2 bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-600 transition flex-1 flex justify-center items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                      </svg>
                      Download My Data
                    </button>
                    <button className="px-4 py-2 bg-red-900/50 text-red-300 border border-red-600 rounded-lg font-medium hover:bg-red-900/70 transition flex-1 flex justify-center items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
